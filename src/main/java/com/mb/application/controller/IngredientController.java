...
public class IngredientController {
    ...
    @GetMapping
    public Set<IngredientResponse> listIngredients(@Param("fields") String name) {
    ...
    public IngredientResponse createIngredient(@RequestBody @Valid AddIngredientRequest ingredient) {
